   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-slate-800">
    ...
    <h1 class="mx-auto font-xl text-sky-400 flex items-center p-5" >Hello, <?= $admin["f_name"]?>.</h1>
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="../index.php" class="flex items-center p-2 text-slate-400 rounded-lg  hover:bg-gray-100">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-slate-400 rounded-lg hover:bg-gray-100">
         ...
         <li>
            <a href="logout.php" class="flex items-center p-2 text-slate-400 rounded-lg hover:bg-gray-100">
