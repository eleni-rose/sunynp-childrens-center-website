      ...
      <div class="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
        <div class="mb-12 md:mb-0">
          ...
          <p class="mb-4">
            ...
            Giving these childern the opportunity to learn and grow is a great thing. I am so happy to be a part of this
            Organization.
          </p>
        ...
        <div class="mb-12 md:mb-0">
          ...
          <p class="mb-4">
            ...
            </svg> Having the opportunity to work with the best team in the world is a dream come true. I am so grateful
            for the chance to get to know these childern and astablish a relationship with them.
          <ul class="flex justify-center mb-0">
            <li>
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="w-4 text-yellow-500"
                role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        ...
        <div class="mb-0">
          ...
          <p class="mb-4">
            ...
            </svg> I love being a teacher. I love the students and I love the opportunity to make a difference in their
            lives.
          </p>
          <ul class="flex justify-center mb-0">
            <li>
