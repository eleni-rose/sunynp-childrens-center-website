...
?>
    <form method="POST" action="editCell.php?pkname=<?php echo $pkname; ?>&id=<?php echo $id; ?>&column=<?php echo $column; ?>&table=<?php echo $table; ?>">
...
<?php
    ...
    if(isset ($_GET['pkname']) && isset ($_GET['id']) && isset ($_GET['column']) && isset($_GET['table']) && isset($_POST['modVal']) && isset($_POST['update']))
    {
        ...
        if (mysqli_query($link, 'UPDATE ' . $table . ' SET ' . $column . '= "' . $modVal . '" WHERE ' . $pkname . ' = ' . $id . ";"))
        {
            ...
            header("location: showTable.php?msg=Record updated successfully");
